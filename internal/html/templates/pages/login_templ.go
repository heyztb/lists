...
func submitLogin() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_submitLogin_1889`,
		Function: `function __templ_submitLogin_1889(){event.preventDefault()
  const form = new FormData(event.target)
  const data = Object.fromEntries(form)
  try {
    srp.loginUser(data['email'], data['password']).then(key => {
      console.log(key)
    })
  } catch (e) {
    console.log(e)
		...
		Call:       templ.SafeScript(`__templ_submitLogin_1889`),
		CallInline: templ.SafeScriptInline(`__templ_submitLogin_1889`),
	}
}
...
func Login() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<!--\n    // v0 by Vercel.\n    // https://v0.dev/t/Ui6lPpyAQKV\n    --> <script type=\"module\" src=\"/assets/srp.min.js\"></script> <div class=\"w-full lg:grid lg:min-h-[600px] lg:grid-cols-2 xl:min-h-[800px]\">")
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"hidden bg-muted lg:block\"><img src=\"/placeholder.svg\" alt=\"Image\" width=\"1920\" height=\"1080\" class=\"h-full w-full object-cover dark:brightness-[0.2] dark:grayscale\" style=\"aspect-ratio: 1920 / 1080; object-fit: cover;\"></div><div class=\"flex items-center justify-center py-12\"><div class=\"mx-auto grid w-[350px] gap-6\"><div class=\"grid gap-2 text-center\"><h1 class=\"text-3xl font-bold\">Login</h1><p class=\"text-balance text-muted-foreground\">Enter your email below to login to your account</p></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Err = templ.RenderScriptItems(ctx, templ_7745c5c3_Buffer, submitLogin())
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<form class=\"grid gap-4\" onSubmit=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			var templ_7745c5c3_Var3 templ.ComponentScript = submitLogin()
