...
const client = new SRPClient(
  ...
  5n,
  BigInt('0xc19711ce7173ce41609dfe278ea110b7b27dd1f298c12ea7eb5bf85df2ebc32d86b16b60a679789b8ce14ea9b671107e')
)
...
const loginUser = async function(identifier, password) {
  ...
  const { key, proof } = await client.step2(identifier, hexToBuf(salt), hexToBigint(A), a, hexToBigint(B), x)
