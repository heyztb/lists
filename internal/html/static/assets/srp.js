import { SRPClient } from './windwalker-srp.min.js'
import * as argon2 from 'argon2' // TODO: replace this with argon2id package
...
const client = new SRPClient(
  ...
  5n,
  BigInt('TODO: Calculate little k from above parameters')
)
...
const registerUser = async function(identifier, password) {
  let { v, salt } = await client.register(identifier, password)
