...
type Comment struct {
	...
	ItemID    null.Uint64 `boil:"item_id" json:"item_id,omitempty" toml:"item_id" yaml:"item_id,omitempty"`
	ListID    null.Uint64 `boil:"list_id" json:"list_id,omitempty" toml:"list_id" yaml:"list_id,omitempty"`
...
var CommentTableColumns = struct {
	...
	ItemID:    "comments.item_id",
	ListID:    "comments.list_id",
...
var CommentWhere = struct {
	...
	ItemID    whereHelpernull_Uint64
	ListID    whereHelpernull_Uint64
	Content   whereHelperstring
	CreatedAt whereHelpertime_Time
	UpdatedAt whereHelpertime_Time
}{
	ID:        whereHelperuint64{field: "`comments`.`id`"},
	UserID:    whereHelperuint64{field: "`comments`.`user_id`"},
	ItemID:    whereHelpernull_Uint64{field: "`comments`.`item_id`"},
	ListID:    whereHelpernull_Uint64{field: "`comments`.`list_id`"},
...
var (
	commentAllColumns            = []string{"id", "user_id", "item_id", "list_id", "content", "created_at", "updated_at"}
	commentColumnsWithoutDefault = []string{"id", "user_id", "item_id", "list_id", "content"}
...
func (q commentQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Comment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "database: failed to execute a one query for comments")
	}
...
func (q commentQuery) All(ctx context.Context, exec boil.ContextExecutor) (CommentSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "database: failed to assign all query results to Comment slice")
	}
...
func (q commentQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "database: failed to count comments rows")
	}
...
func (q commentQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "database: failed to check if comments exists")
	}
...
func FindComment(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*Comment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "database: unable to select from comments")
	}
...
func (o *Comment) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("database: no comments provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to insert into comments")
	}
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to populate default values for comments")
	}
...
func (o *Comment) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("database: unable to update comments, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to update comments row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: failed to get rows affected by update for comments")
	}
...
func (q commentQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to update all for comments")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to retrieve rows affected for comments")
	}
...
func (o CommentSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to update all in comment slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to retrieve rows affected all in update all comment")
	}
	return rowsAff, nil
}
...
func (o *Comment) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("database: no comments provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("database: unable to upsert comments, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to upsert for comments")
	}
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to retrieve unique values for comments")
	}
...
func (o *Comment) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("database: no Comment provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to delete from comments")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: failed to get rows affected by delete for comments")
	}
...
func (q commentQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("database: no commentQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to delete all from comments")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "database: failed to get rows affected by deleteall for comments")
	}
...
func (o CommentSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "database: unable to delete all from comment slice")
	}
...
func (o *CommentSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "database: unable to reload all in CommentSlice")
	}
...
func CommentExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "database: unable to check if comments exists")
	}
